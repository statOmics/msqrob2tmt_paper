...
format:
  pdf:
    ...
    include-in-header:
      text:
        \usepackage{amsmath, booktabs, caption, longtable, xcolor}
editor: source
crossref:
...
knitr::include_graphics("../figs/model_overview.png", error = FALSE)
...
#| fig-pos: 'H'
knitr::include_graphics("../figs/spikein1_tpr_fdp.png", error = FALSE)
...
#| fig-cap: "Boxplots showing the log2 FC distributions for the spike-in proteins, focusing on two comparisons with the highest and lowest difference in spike-in concentrations. Fold changes are estimated by DEqMS, msqrob2TMT, MSstatsTMT, and msTrawler workflows. The grey dotted line is the true log2 FC for the comparison. Panel A: non spike-in proteins (yeast); Panel B: spike-in proteins."
#| fig-pos: 'H'
knitr::include_graphics("../figs/spikein1_logFC.png", error = FALSE)
```
...
knitr::include_graphics("../figs/spikein1_msqrob2_estimation_features.png", error = FALSE)
...
knitr::include_graphics("../figs/spikein2_tpr_fdp.png", error = FALSE)
```
...
#| fig-pos: 'H'
knitr::include_graphics("../figs/spikein2_logFC.png", error = FALSE)
```
...
#| fig-pos: 'H'
knitr::include_graphics("../figs/spikein1_supp_tpr_fdp.png", error = FALSE)
```
...
#| fig-pos: 'H'
knitr::include_graphics("../figs/spikein1_supp_comparison_1.png", error = FALSE)
```
...
#| fig-pos: 'H'
knitr::include_graphics("../figs/spikein1_supp_comparison_2.png", error = FALSE)
```
...
knitr::include_graphics("../figs/spikein1_supp_comparison_3.png", error = FALSE)
```
...
knitr::include_graphics("../figs/spikein1_supp_tpr_fdp_replication.png", error = FALSE)
```
...
#| fig-pos: 'H'
knitr::include_graphics("../figs/spikein1_null_distribution.png", error = FALSE)
```
...
knitr::include_graphics("../figs/spikein1_supp_compare_preprocess.png", error = FALSE)
```
...
knitr::include_graphics("../figs/spikein2_supp_tpr_fdp.png", error = FALSE)
```
...
knitr::include_graphics("../figs/spikein2_supp_compare_preprocess.png", error = FALSE)
```
...
#| fig-pos: 'H'
knitr::include_graphics("../figs/spikein2_null_distribution.png", error = FALSE)
```
...
knitr::include_graphics("../figs/mouse_upset_early.png", error = FALSE)
...
knitr::include_graphics("../figs/mouse_upset_late.png", error = FALSE)
...
knitr::include_graphics("../figs/mouse_upset_average.png", error = FALSE)
```

```{r, eval=FALSE, echo  =FALSE, message  =FALSE, warning = FALSE, out.width="100%"}
#| label: fig-Upset-int
#| fig-cap: "Upset plot showing the overlap in significant proteins between the MSstatsTMT and the msqrob2TMT workflows for the interaction."
#| fig-pos: 'H'

knitr::include_graphics("../figs/mouse_upset_interaction.png", error = FALSE)
...
knitr::include_graphics("../figs/mouse_supp_ora.png", error = FALSE)
...
knitr::include_graphics("../figs/mouse_supp_null_distribution.png", error = FALSE)
```
